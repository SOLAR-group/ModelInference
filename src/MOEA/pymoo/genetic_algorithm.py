...
class GeneticAlgorithm(Algorithm):
    ...
    def __init__(self,
        ...
        # other run_id specific data updated whenever solve is called - to share them in all algorithms
        self.n_gen = None
        self.pop = None
        self.off = None
    ...
    def _initialize(self):
        ...
        print("Time evaluation: " + str(round(time.perf_counter()-start_eval, 1)))
